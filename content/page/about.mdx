...
sections:
  ...
  - title: Data
    body: >
      ...
      | Grocery Store Locations           | InfoGroup Reference USA / Data Axle
      | 1997-2023 |

      | Grocery Store Corporate Ownership | InfoGroup Reference USA / Data Axle
      | 1997-2023 |
      ...
      \* used to calculate Food Access score
      ...
      \* used to calculate Residential Segregation score
      ...
      American Community Survey / U.S. Census Geographic Boundaries
      ...
      U.S. Census Centers of Population
...
How does a consolidating grocery industry affect food accessibility for communities across the United States? What are the structural conditions driving the decision to close one grocery store and open another? How do impacts of segregation, economic disadvantage, and geographic patterns of food insecurity factor in?							&#x9;

Feeding Fairness visualizes data to help explore and find answers to these questions. We aim to better understand the structural factors that contribute to food insecurity in communities across the U.S., experienced at disproportionately high rates in rural and non-white communities. Specifically, we consider the most basic place to access food -- the grocery store -- and its relationships to inequitable outcomes. 

### Acknowledgements

This project is a collaboration between national nonprofit organization RAFI-USA and the Open Spatial Lab (OSL) at the University of Chicago Data Science Institute. It is supported by the Robert Wood Johnson Foundation.  
