...
sections:
  - title: Known Issues
    body: >
      ...
      * Some locations are reported with an older store or location name.

      * Some locations that are part of a larger plaza or mall location are not
      properly coded as grocery stores (or related locations).
