...
overview:
  - title: Economic Advantage
    ...
    templates:
      - body: |
          One of the most economically advantaged tracts.
        threshold: 90
      - body: |
      ...
      - body: |
        ...
        threshold: 10
      - body: |
          One of the most disadvantaged tracts.
        threshold: 0
    measure: adi
  - title: Segregation
    ...
    templates:
      - body: |
          Among the most integrated census tracts.
        threshold: 90
      - body: |
          Average segregation.
        threshold: 50
      - body: |
          Moderately to very segregated.
        threshold: 25
      - body: |
          One of the most segregated census tracts.
        threshold: 0
    measure: segregation
  - title: Market Power
    ...
    templates:
      - body: >
          This tract has a lower market concentration than
          %%100|-|hhi\_2023\_percentile%%% of all tracts.
    measure: hhi
  - title: Food Access
    ...
    templates:
      ...
      - body: >
          ...
          access than %%100|-|gravity\_2023\_percentile%%% of counties.
        threshold: 25
  ...
  - title: Economic Advantage
    column: ADI_NATRANK
    tooltip: >
      Economic advantage of this county relative to the whole country ... ADI
      description here
    templates:
      - body: |
          One of the most economically advantaged counties.
        threshold: 90
      - body: |
          Moderately advantaged
        threshold: 70
      ...
      - body: |
        ...
        threshold: 10
      - body: |
          One of the most disadvantaged counties.
        threshold: 0
    measure: adi
  - title: Racial Equity
