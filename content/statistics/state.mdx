...
stat:
  - title: Median Food Access (Gravity)
    ...
    templates:
      - body: >
          The gravity value for ... state is %%gravity\_2021%%.
  ...
  - title: Median Market Concentration (HHI)
    column: hhi_2021
    tooltip: "Market concentration is a measure of diversity in the marketplace. It looks at how dominant single grocery stores are in an area. This measure is calculated using the Herfindahl–Hirschman Index (HHI).\n\nThis score reflects the median tract value for the state. The score is relative to the rest of the United States, where one hundred (100) is the most evenly competitive marketplace and zero (0) is a market with a total monopoly.\n\nFor more information on how this measure is calculated, read our\_[methodology](http://localhost:3000/about#methodology).\n"
    templates:
      - body: >
  ...
  - title: Median Segregation
    ...
    tooltip: "ICE (Indicators of Concentration at the Extremes) is a measure that looks at how concentrated and how separate populations live within an area. In this case, the ICE metric reflects how segregated black or african american and white people tend to be in the state.\n\nFor more information on how this measure is calculated, read our\_[methodology](http://localhost:3000/about#methodology).\n"
    templates:
      - body: >
          The median ICE value in the state for black or african american and
...
overview:
  - title: Economic Advantage
    column: ADI_NATRANK
    tooltip: >
      Economic advantage of this state relative to the whole country ... ADI
      description here
    templates:
      - body: |
          One of the most economically advantaged states.
        threshold: 90
      - body: |
      ...
      - body: |
        ...
        threshold: 10
      - body: |
          One of the most disadvantaged states.
        threshold: 0
    measure: adi
  - title: Segregation
    ...
    templates:
      - body: |
          Among the most integrated census states.
        threshold: 90
      - body: |
          Average segregation.
        threshold: 50
  ...
  - title: Market Power
    ...
    templates:
      - body: >
          ...
          %%100|-|hhi\_2023\_percentile%%% of all states.
    measure: hhi
  - title: Food Access
    ...
    templates:
      - body: "The access people have to buy groceries. %%NAME%% is in the top\_%%100|-|gravity\\_2023\\_percentile%%% of all states.\n"
        threshold: 75
      - body: >
