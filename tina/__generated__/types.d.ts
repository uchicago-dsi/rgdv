...
export type TooltipsConnectionQuery = {
  __typename?: "Query"
  tooltipsConnection: {
    __typename?: "TooltipsConnection"
    totalCount: number
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    ...
    tooltips(
      variables: TooltipsQueryVariables,
      options?: C
    ): Promise<{
      data: TooltipsQuery
      errors?: { message: string; locations: { line: number; column: number }[]; path: string[] }[]
      ...
      return requester<
        ...
        TooltipsQueryVariables
      >(TooltipsDocument, variables, options)
    },
    tooltipsConnection(
      variables?: TooltipsConnectionQueryVariables,
      options?: C
    ): Promise<{
      data: TooltipsConnectionQuery
      errors?: { message: string; locations: { line: number; column: number }[]; path: string[] }[]
      variables: TooltipsConnectionQueryVariables
      query: string
    }> {
      return requester<
        ...
        TooltipsConnectionQueryVariables
      >(TooltipsConnectionDocument, variables, options)
    },
  }
}
